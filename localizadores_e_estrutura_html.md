...
Basta inspecionar o elemento na página e procurar o atributo correspondente no HTML. 
...
No painel de desenvolvimento, clique com o botão direito no elemento destacado


Para copiar o CSS Selector: "Copy → Copy selector"


Para copiar o XPath: "Copy → Copy XPath"


Funções para selecionar elementos no Playwright

No Playwright, a principal função para trabalhar com elementos é o locator().

locator(selector)

Cria um objeto que referencia o(s) elemento(s) encontrado(s).

const elemento = page.locator(".produto-card");
